...
const SignupPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-white dark:bg-slate-950">
      ...
      <div className="hidden lg:flex relative bg-slate-950 overflow-hidden">
        ...
        <div className="relative z-10 w-full flex flex-col justify-between p-12">
          ...
          <Link href="/" className="flex items-center gap-2 group w-fit">
            <div className="h-12 w-12 bg-blue-600 dark:bg-teal-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
          ...
          <div className="max-w-md space-y-8">
            <div className="space-y-4">
              <Badge className="bg-teal-500/10 text-teal-400 border-teal-500/20 px-3 py-1 text-xs">Join 50,000+ Users</Badge>
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={idx} className="flex items-center gap-4 group">
                  <div className="h-10 w-10 rounded-lg bg-white/5 flex items-center justify-center border border-white/10 group-hover:bg-white/10 transition-all">
      ...
      <div className="flex items-center justify-center p-8 bg-gradient-to-tr from-teal-50/50 via-white to-blue-50/50 dark:from-slate-950 dark:via-slate-900/50 dark:to-slate-950">
        <div className="w-full max-w-md space-y-7 animate-fade-in">
          ...
          <div className="text-center lg:text-left space-y-1">
            ...
            <p className="text-slate-500 dark:text-slate-400">Join the future of legal tech in Africa.</p>
          </div>

          <Button 
            variant="outline" 
            onClick={handleGoogleSignup}
            className="w-full py-6 dark:border-slate-800 dark:bg-slate-900/50 dark:hover:bg-slate-800 dark:text-white flex items-center justify-center gap-3 text-base shadow-sm hover:shadow-md transition-all rounded-xl"
          >
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="email" className="text-slate-700 dark:text-slate-300 text-sm font-semibold ml-1">Email</Label>
              <Input
                id="email"
                type="email"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <Label htmlFor="password" className="text-slate-700 dark:text-slate-300 text-sm font-semibold ml-1">Password</Label>
                <Input
                  id="password"
                  type="password"
                  placeholder="••••••••"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="confirm-password" className="text-slate-700 dark:text-slate-300 text-sm font-semibold ml-1">Confirm</Label>
                <Input
                  id="confirm-password"
                  type="password"
                  placeholder="••••••••"
            ...
            <Button 
              type="submit" 
              className="w-full py-6 bg-teal-600 hover:bg-teal-700 dark:bg-gradient-to-r dark:from-teal-600 dark:to-emerald-600 dark:hover:from-teal-700 dark:hover:to-emerald-700 text-white font-bold rounded-xl shadow-lg shadow-teal-500/20 dark:shadow-emerald-900/20 group transition-all"
              disabled={isLoading}
            >
              {isLoading ? (
