      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="group bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-900 dark:to-slate-800 rounded-2xl p-10 border border-gray-200 dark:border-slate-700 hover:border-blue-400 dark:hover:border-teal-500 hover:shadow-xl hover:from-blue-50 dark:hover:from-teal-900/20 transition-all duration-300"
            >
              {/* Icon */}
        ...
        {/* Supporting Stats */}
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-teal-600 dark:from-teal-600 dark:via-emerald-600 dark:to-cyan-700 rounded-3xl p-12 text-white text-center">
          <h3 className="text-3xl font-bold mb-4">Trusted by Thousands</h3>
          <p className="text-lg text-blue-100 dark:text-teal-100 max-w-2xl mx-auto mb-8">
          ...
          <div className="inline-block">
            ...
            <p className="text-blue-100 dark:text-teal-100">Legal Queries Resolved</p>
          </div>
        </div>
      </div>
    </section>
